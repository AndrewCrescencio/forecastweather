...
const dayWeekArr = ["Sunday", "Monday", "Tuesday", "Wednesday", "Thursday", "Friday", "Saturday"];
...
const weather = {
    ...
    displayWeather(data) {
        ...
        document.querySelector('.current__date').innerText = `${hour}:${minute} - ${dayWeekArr[dayWeek]}, ${dayMonth} ${monthArr[month]} ${year}`
        ...
        document.querySelector('.current__description').innerText = current_description;
        ...
        document.querySelector('.current__humidity').innerText = current_humidity + "%";
        ...
        for (let i = 0; i < 24; i++) {
            ...
            const hour_chancerain = data.forecast.forecastday[0].hour[i].chance_of_rain;
